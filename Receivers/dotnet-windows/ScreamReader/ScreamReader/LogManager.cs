...
namespace ScreamReader
{
    ...
    public static class LogManager
    {
        ...
        private static volatile LogLevel minimumLevel = LogLevel.Info;
        ...
        /// <summary>
        /// Returns true if a message at <paramref name="level"/> would be shown. Callers can use this
        /// to skip building expensive log strings on hot paths when the level is filtered out.
        /// </summary>
        ...
        private static void AddLog(LogLevel level, string message)
        {
            ...
            // Raise event for UI updates outside the lock (only if level is visible)
